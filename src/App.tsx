  ...
  return (
    <ReactLenis root>
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="group fixed bottom-6 right-6 lg:bottom-10 lg:right-10 z-[99999] inline-flex rounded-pill p-[2px] bg-gradient-to-r from-brand via-brandAlt to-skyLight shadow-[0_10px_25px_-8px_rgba(24,113,255,0.55)] transition-transform duration-300 ease-out hover:scale-105 active:scale-95"
      >
